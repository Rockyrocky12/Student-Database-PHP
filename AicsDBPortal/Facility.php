...
<header class="clearfix">
		...
		<div class="cimg">
  			<center><img class="vis" src="Pictures/facility1.svg" alt=""></center>	
		</div>
		<div class="thead">
  			<h1>Facility</h1>
		</div>
		<div class="qtext">
  			<div class="text">
			 <p> As an IT institution one of its primary concern is to provide modern facilities that are conducive
			  to learning and adaptable to the latest technology set-up. The school has provided the students 
			  with air- conditioned classrooms and library that houses books related to computer and other 
			  subjects; laboratories with 1:1 computer ratio and Internet facility; well- equipped technical 
			  laboratory; P.E. area; guidance office; clinic; faculty; administration office; and utility room.</p>
			  </div>
		</div>
